...
_sewa.expiredCheck(xavior, sewa)
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await xavior.setStatus(`${'©FadliMd'} | Runtime : ${runtime(uptime)}`)
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case 'sc': {
                anu = `*Kalian Bisa Cek Yt FadliMd:*
https://youtube.com/channel/UCadk5BwVWzj-r_x0JGwZMRg
...
let btn = [{
                        ...
                        xavior.send5ButImg(m.chat, anu, '©FadliMd', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        xavior.send5ButGif(m.chat, anu, '©FadliMd', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, '©FadliMd', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        xavior.send5ButMsg(m.chat, anu, '©FadliMd', btn)
                        } else if (setbot.templateLocation) {
                        xavior.send5ButLoc(m.chat, anu, '©FadliMd', global.thumb, btn)
                        }
                     }
            break
            case 'chat': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, '©FadliMd', m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, '©FadliMd', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Group`, '©FadliMd', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Edit Info`, '©FadliMd', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Antilink`, '©FadliMd', m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${'©FadliMd'} telah di mute di group ini !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya`)
                db.data.chats[m.chat].mute = false
                m.reply(`${'©FadliMd'} telah di unmute di group ini !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await xavior.sendButtonText(m.chat, buttons, `Mute Bot`, '©FadliMd', m)
                }
             }
             break
            ...
            case 'ephemeral': {
                ...
                xavior.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, '©FadliMd', `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://youtube.com/channel/zyrexxmc-r_x0JGwZMRg'
                                }
                                }, {
                                urlButton: {
                                    displayText: 'Website Bot',
                                    url: 'https://asukayang7.github.io'
                                }
                                }, {
                                quickReplyButton: {
                      ...
                      xavior.send5ButImg(i, txt, '©FadliMd', global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    displayText: 'My Youtube️',
                                    url: 'https://youtube.com/channel/zyrexxmc'
                                }
                                }, {
                                urlButton: {
                                    displayText: 'Website Bot',
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      xavior.send5ButImg(yoi, txt, '©FadliMd', global.thumb, btn)
		}
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            xavior.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${'©FadliMd'}.mp3`}, { quoted : m })
            }
            break
	    ...
	    case 'yts': case 'ytsearch': {
                if (!text) throw `Example : ${prefix + command} FadliMd`
	    ...
	    case 'anonymous': {
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, '©FadliMd', m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await xavior.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '©FadliMd', m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await xavior.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '©FadliMd', m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, '©FadliMd', m)
                }
                break
            }
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                xavior.sendListMsg(m.chat, `Please select the menu you want to change!`, '©FadliMd', `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6281908052908?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  SHOPPEPAY
├  DANA
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6281908052908?text=JADIBOT
╰────
╭─[ *PAYMENT* ]
├  SHOPPEPAY
├  SHOPPEPAY2
...
let btn = [{
            ...
            break
case 'shoppepay': {
                xavior.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/a43aa54a0d0ce2c958b6e.png' }, caption: `shoppepay` }, { quoted: m })
            }
            break
case 'dana': {
                xavior.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/a43aa54a0d0ce2c958b6e.png' }, caption: `ShoppePay2` }, { quoted: m })
            }
            break
case 'pulsa': {
m.reply('081908052908')
}
break
// Button List
case 'command':{
